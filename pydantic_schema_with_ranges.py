...
class Biomarker(BaseDocumentModel):
    ...
    biomarkernonmutationstatus: Literal["Positive", "Negative", "Elevated", "High", "Low", "Normal", "Other"] = Field("Other", description="Non-mutation status or value (use \"Other\" if not applicable)")
